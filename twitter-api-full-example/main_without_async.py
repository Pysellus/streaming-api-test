...
if __name__ == "__main__":
    ...
    loop.run_in_executor(executor, process_stream, retweeted_tweets, retweet_test)
    loop.run_in_executor(executor, process_stream, in_japanese_tweets, emoji_test)
    loop.run_in_executor(executor, process_stream, spanish_hashtags, hashtag_test)
